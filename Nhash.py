...
quanthash = 2     #quantidade de hashs    2 , 4  , 8
teste = []
...
for d in tabela:
    ...
    n_bits = int(np.ceil(np.log2(quant)))   # quantidade de bits a serem pegos
    ...
    ay = int(np.ceil((2**(n_bits))/quanthash))  # quantidade de linhas 
    ...
    #print(n_bits ,quant , ay , quanthash) #numero de bits pegos / numero de termos / numero de hashs     
print(teste)
